...
class IAgent:
    def __init__(self):
        ...
        self.gridColumns: int = 29
        self.gridRows: int = 39
        self.robot: IRobot = None
...
class Agent(IAgent):
    def __init__(self, playerId: str or None = None, arena: str or None = None, username: str or None = None,
        ...
        if (welcomePrint):
            ...
            print("Hi there 👋")
            print(
                "To see the arena in your web browser 🎮, go to 👉 https://play.jusdeliens.com/?viewer=pytactx&arena=" + str(
                    arena) + "&url=" + str(server) + "&usr=" + str(username) + "&pseudo=" + str(playerId))
        ...
        self.robot: IRobot = rbx.OvaClientMqtt(robotId, arena, username, password, server, port, imgOutputPath,
                                               autoconnect, useProxy, verbosity, playerId, False)
...
class AgentFr(IAgentFr):
    def __init__(self, nom: str or None = None, arene: str or None = None, username: str or None = None,
        ...
        if (welcomePrint):
            ...
            print("Hey 👋")
            print(
                "Pour visualiser l'arene de jeu 🎮, allez sur 👉 https://play.jusdeliens.com/?viewer=pytactx&arena=" + str(
                    arene) + "&url=" + str(url) + "&usr=" + str(username) + "&pseudo=" + str(nom))
